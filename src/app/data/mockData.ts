...
export const mockProperties: Property[] = [
  ...
  },
  {
    ...
    descricao: 'Apartamento luxuoso na zona da Praia, com vista para o mar. Condomínio com piscina, ginásio e segurança 24h.',
    tipo: 'arrendamento',
    preco: 18000,
    localizacao: 'Praia',
    cidade: 'Maputo',
  ...
  },
  {
    ...
    descricao: 'Casa familiar num bairro calmo em Nampula, perfeita para quem procura conforto e tranquilidade. Totalmente renovada.',
    tipo: 'venda',
    preco: 2800000,
  ...
  },
  {
    ...
    descricao: 'Villa de design contemporâneo com arquitetura arrojada, sistema domótico e painéis solares. Vista panorâmica em Xai-Xai.',
    tipo: 'venda',
    preco: 9500000,
    localizacao: 'Praia do Bilene',
    cidade: 'Xai-Xai',
    tipologia: 'T5',
    area: 380,
  ...
  },
  {
    ...
    descricao: 'Apartamento novo em edifício moderno no coração de Beira. Próximo de transportes, comércio e serviços.',
    tipo: 'arrendamento',
    preco: 12000,
  ...
  },
  {
    ...
    descricao: 'Casa espaçosa ideal para famílias em Chimoio, com quintal amplo e churrasqueira. Zona residencial tranquila.',
    tipo: 'venda',
    preco: 3200000,
